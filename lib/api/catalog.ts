...
import type { ApiResponse, Campus, CatalogData, Room, SchoolClass } from "@/lib/api/types"
...
export const createCampus = (name: string) => api.post("/campus/create", { name })
export const editCampus = (id: number, name: string) => api.post("/campus/edit", { id, name })
